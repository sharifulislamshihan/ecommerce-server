...
const jwtRefreshKey = process.env.JWT_REFRESH_KEY || "jas83&bd^#fk874y&^)*hu(6jba8^769";

const jwtResetPasswordKey = process.env.JWT_RESET_PASSWORD_KEY || "jas83&bd^#fk874y&^)*hu(6jba8^769";
